...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.jsx`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.jsx": () => import("./assets/ConfirmPassword-C5z4vo2G.js"), "./Pages/Auth/ForgotPassword.jsx": () => import("./assets/ForgotPassword-DsEPxP0K.js"), "./Pages/Auth/Login.jsx": () => import("./assets/Login-CBCK4JoK.js"), "./Pages/Auth/Register.jsx": () => import("./assets/Register-DZlS1StF.js"), "./Pages/Auth/ResetPassword.jsx": () => import("./assets/ResetPassword-FE_-TZW-.js"), "./Pages/Auth/VerifyEmail.jsx": () => import("./assets/VerifyEmail-V-5uwRBv.js"), "./Pages/Dashboard.jsx": () => import("./assets/Dashboard-DPTbbwIr.js"), "./Pages/DataDeletion.jsx": () => import("./assets/DataDeletion-BiTlfrXi.js"), "./Pages/PrivacyPolicy.jsx": () => import("./assets/PrivacyPolicy-lpRpnXad.js"), "./Pages/Profile/Edit.jsx": () => import("./assets/Edit-BSxX3ceS.js"), "./Pages/Profile/Partials/DeleteUserForm.jsx": () => import("./assets/DeleteUserForm-DasR_Sgc.js"), "./Pages/Profile/Partials/UpdatePasswordForm.jsx": () => import("./assets/UpdatePasswordForm-CwhF3nns.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.jsx": () => import("./assets/UpdateProfileInformationForm-GzmQdpBg.js"), "./Pages/TermsOfService.jsx": () => import("./assets/TermsOfService-C6JxmEZf.js"), "./Pages/Welcome.jsx": () => import("./assets/Welcome-wbQb3jwF.js"), "./Pages/WhatsApp/Automation.jsx": () => import("./assets/Automation-CYg3A2pv.js"), "./Pages/WhatsApp/Connect.jsx": () => import("./assets/Connect-Hdp_7a4u.js"), "./Pages/WhatsApp/MessageLogs.jsx": () => import("./assets/MessageLogs-C8DMBSWX.js"), "./Pages/WhatsApp/SendMessage.jsx": () => import("./assets/SendMessage-QRRloHGJ.js") })
    ),
    setup: ({ App, props }) => {

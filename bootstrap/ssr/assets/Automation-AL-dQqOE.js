        ...
        /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-4xl sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900 dark:text-gray-100", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8 pb-6 border-b border-gray-200 dark:border-gray-700", children: [
            ...
            /* @__PURE__ */ jsxs("label", { className: "inline-flex items-center cursor-pointer", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "ms-3 text-sm font-medium text-gray-900 dark:text-gray-300", children: data.is_automation_enabled ? "Active" : "Paused" })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("form", { onSubmit: handleSave, className: `space-y-6 ${!data.is_automation_enabled || !isConnected ? "opacity-50" : ""}`, children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-500", children: "When a user message contains any of these words, the auto-reply will trigger. (Leave empty to trigger on ALL messages)" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: processing ? "Saving..." : "Save Automations"
                }
              ),
              recentlySuccessful && /* @__PURE__ */ jsx("span", { className: "text-sm text-green-600 dark:text-green-400", children: "Settings saved successfully!" })
            ] })
          ] })
        ] }) }) }) })
      ]
